...
%{__make} %{?_smp_mflags} CPU="generic" TARGET="linux2628" USE_DL=1 USE_LUA=1 LUA_LIB=/opt/lua-5.3.1/src LUA_INC=/opt/lua-5.3.1/src USE_OPENSSL=1 USE_PCRE=1 USE_ZLIB=1 ${regparm_opts} ADDINC="%{optflags}" USE_LINUX_TPROXY=1 ADDLIB="%{__global_ldflags}" DEFINE=-DTCP_USER_TIMEOUT=18
